...
Sage.init = function(elementNamesToInitLegacy) {
  let initDocumentTagListener = function(elParentSelector, initFunc, destroyFunc) {
  ...
  initDocumentTagListener('[data-js-modal]',           Sage.modal.init,            Sage.modal.destroy);
  initDocumentTagListener('[data-js-modaltrigger]',    Sage.modal.initTrigger,     Sage.modal.destroyTrigger);
