Sage.popover = (function() {
  ...
  function unbind(el) {
    el.querySelector(`[${POPOVER_OVERLAY}]`).removeEventListener('click', popoverOverlayClickHandler);
  ...
  function popoverOverlayClickHandler(evt) {
    ...
    content.classList.remove('sage-popover__panel--is-expanded');
  ...
  function openPopoverPanel(el, content) {
    ...
    content.classList.add('sage-popover__panel--is-expanded');
  }
