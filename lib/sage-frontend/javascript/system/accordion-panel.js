Sage.accordion = (function () {
  ...
  function init() {
    const accordionHeaderEls = document.querySelectorAll(`[${JS_ACCORDION_ROOT}="${JS_ACCORDION_HEADER}"]`);
    console.log('accordion', accordionHeaderEls);

    if (accordionHeaderEls !== null) {
      accordionHeaderEls.forEach(setupAccordion);
    }
  }
